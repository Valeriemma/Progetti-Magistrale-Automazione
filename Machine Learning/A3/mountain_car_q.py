...
def run(episodes, is_training, render):
    ...
    # Crea un istanza dell'ambiente MountainCar
    # Se: - render_mode == True  --> render_mode = 'human', verrà visualizzata una rappresentazione grafica dell'ambiente.
    #     - render_mode = False  --> render_mode = None, non verrà visualizzata una rappresentazione grafica dell'ambiente.
    env = gym.make('MountainCar-v0', render_mode='human' if render else None)

    # Rappresento 'pos_space' e 'vel_space' in 20 pti equamente distributi all'interno dei limiti degli spazi di posizione e velocità dell'ambiente. 
